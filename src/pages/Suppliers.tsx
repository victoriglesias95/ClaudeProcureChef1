...
import { getSuppliers } from '../services/quotes';
...
const Suppliers = () => {
  ...
  const handleAddSupplier = () => {
    toast.info('Add supplier functionality coming soon!');
  };

  const handleEditSupplier = (supplierId: string) => {
    toast.info(`Edit supplier functionality coming soon! ID: ${supplierId}`);
  };

  const handleViewSupplierDetails = (supplierId: string) => {
    toast.info(`Supplier details view coming soon! ID: ${supplierId}`);
  };
